...
export const COPY = {
  ...
  pickupShippingBlurb: `Order online, then email ${CONTACT_EMAIL} to schedule pickup at the house (${PICKUP_ADDRESS}) — free. Hours vary; email first. Honey ships in Virginia only. Summer Lotion and Dipper ship continental US.`,
  footerPickup: 'New Market, VA · Email johnabiddle@gmail.com to schedule pickup ·',
  footerHoney: 'Honey ships in Virginia only.',
  cartPageNote: `Order online, then email ${CONTACT_EMAIL} to schedule pickup at the house (${PICKUP_ADDRESS}) — free. Hours vary; email first. Virginia shipping starts at $11. Honey ships in Virginia only.`,
  ...
  checkoutPickupHint: `Pickup is at ${PICKUP_ADDRESS}. Hours vary — email ${CONTACT_EMAIL} to schedule. When you pick up you can see the bees that made it.`,
  ...
  successPickup: `Your order is marked for pickup at the house (${PICKUP_ADDRESS}). Email ${CONTACT_EMAIL} to schedule — hours vary; email first. When you pick up you can see the bees that made it.`,
